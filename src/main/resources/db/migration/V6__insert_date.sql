 ...
 INSERT INTO orders (id,userId,logisticsRecordId,totalPrice,status,createTime,paidTime,withdrawnTime,finishTime) VALUES ( 1, 1, 1, 10,'unPaid','2018-04-11 09:36:21',NULL ,NULL ,NULL);
 INSERT INTO orders (id,userId,logisticsRecordId,totalPrice,status,createTime,paidTime,withdrawnTime,finishTime) VALUES ( 2, 1, 2, 10,'paid','2018-04-11 09:36:21','2018-04-11 09:36:21' ,NULL ,NULL);
 INSERT INTO orders (id,userId,logisticsRecordId,totalPrice,status,createTime,paidTime,withdrawnTime,finishTime) VALUES ( 3, 1, 3, 10,'withdrawn','2018-04-11 09:36:21',NULL ,'2018-04-11 09:36:21',NULL);
 INSERT INTO orders (id,userId,logisticsRecordId,totalPrice,status,createTime,paidTime,withdrawnTime,finishTime) VALUES ( 4, 1, 3, 10,'finished','2018-04-11 09:36:21','2018-04-11 09:36:21' ,NULL ,'2018-04-11 09:36:21');
